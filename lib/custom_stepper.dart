...
// modify custom stepper for Made4U app
...
const Color _kDisabledLight = Colors.white38;
const Color _kDisabledDark = Colors.white38;
const double _kStepSize = 34.0;
...
class _StepperState extends State<CustomStepper> with TickerProviderStateMixin {
  ...
  Widget _buildChildIcon(int index) {
    if (index == 0) {
    ...
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: widget.steps[index].state == CustomStepState.complete
  ...
  Widget _buildHeaderText(int index) {
    return Column(
      crossAxisAlignment: widget.type == CustomStepperType.horizontal &&
          widget.steps[index].isStepperTypeHorizontalBottom == true
    ...
    final List<Widget> children = <Widget>[
      for (int i = 0; i < widget.steps.length; i += 1) ...<Widget>[
        InkResponse(
          ...
          child: widget.type == CustomStepperType.horizontal &&
          ...
          Expanded(
            child: Column(
              children: [
                Container(
                  height: 6.0,
                  color: widget.steps[i].state == CustomStepState.complete
                      ? Colors.yellow
                      : Colors.red,
                ),
                widget.type == CustomStepperType.horizontal &&
                    widget.steps[i].isStepperTypeHorizontalBottom == true &&
                    widget.steps[i]
      ...
      children: <Widget>[
        ...
        Expanded(
          child: ListView(
            ...
            physics: widget.physics,
            padding: const EdgeInsets.only(left: 24.0, right: 24.0, bottom: 4),
            children: <Widget>[
              AnimatedContainer(
                curve: Curves.fastOutSlowIn,
                duration: kThemeAnimationDuration,
